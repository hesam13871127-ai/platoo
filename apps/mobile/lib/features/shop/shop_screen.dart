          ...
          child: Stack(
            children: [
              ...
              Row(children: [
                ...
                const SizedBox(width: 12),
                Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: Colors.white.withOpacity(.14), shape: BoxShape.circle, boxShadow: [BoxShadow(color: Colors.white.withOpacity(.25), blurRadius: 26)]), child: const Icon(Icons.auto_awesome_rounded, size: 62, color: Colors.white)),
              ]),
            ],
          ),
        ),
