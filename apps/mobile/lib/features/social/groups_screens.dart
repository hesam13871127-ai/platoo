          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Spacer(),
                if (role == 'owner') const Icon(Icons.crown_rounded, size: 15, color: AppTheme.gold),
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _HeaderChip(icon: myRole == 'owner' ? Icons.crown_rounded : myRole == 'admin' ? Icons.shield_rounded : Icons.person_rounded, label: 'You: $myRole'),
                  ],
                ),
              ],
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [if (role == 'owner') const _RolePill(icon: Icons.crown_rounded, label: 'Owner', color: AppTheme.gold) else if (role == 'admin') const _RolePill(icon: Icons.shield_rounded, label: 'Admin', color: AppTheme.violet) else Text('@${member['username'] ?? 'player'}', style: TextStyle(fontSize: 11, color: Theme.of(context).colorScheme.onSurfaceVariant))]),
                ],
              ),
            ),
            if (!isSelf) ...[
