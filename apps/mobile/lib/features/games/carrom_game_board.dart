...
class _CarromGameBoardState extends State<CarromGameBoard> {
  ...
  String _status(bool isTurn, bool pendingCover, bool finished) {
    ...
    if (isTurn) return pendingCover ? 'Your turn · cover the queen with one of your coins.' : 'Your turn · choose up to 3 coins, then strike.';
    return 'Choose your color by pocketing a coin. The queen needs a cover.';
  }
  ...
  void _foul() {
    widget.onAction({'type': 'strike', 'power': power.round(), 'pocketed': <int>[], 'queen': false, 'foul': true});
  }
